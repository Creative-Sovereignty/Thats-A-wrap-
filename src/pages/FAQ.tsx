...
const faqs = [
  { q: "What is AIFilmz?", a: "AIFilmz is an AI-powered filmmaking studio that helps you create stunning short films from script to screen — including scriptwriting, storyboarding, shot planning, AI video generation via Luma Dream Machine, a multi-track video editor, and AI music generation." },
  { q: "Do I need filmmaking experience?", a: "Not at all. AIFilmz is designed for creators at every level. The AI assists with each step — from Director AI shot breakdowns to AI-generated video clips — so you can focus on your creative vision." },
  { q: "What can I create with AIFilmz?", a: "You can write scripts, generate storyboard images, plan shot lists, generate AI videos in the AI Studio (/ai-studio), edit on a multi-track timeline with dialog/score/sound design tracks, and create AI-generated music — all from a single dashboard." },
  ...
  { q: "Can I install AIFilmz on my phone?", a: "Yes! AIFilmz is a Progressive Web App (PWA). Visit the app in your mobile browser and tap 'Add to Home Screen' for a native app-like experience that works offline." },
  { q: "What AI models power AIFilmz?", a: "We use state-of-the-art models for text generation, image synthesis (storyboards), video generation (Luma Dream Machine), and music composition — all accessible without needing your own API keys." },
  { q: "Is there a free plan?", a: "AIFilmz offers free credits to get started. You can create projects, write scripts, and explore the tools. Paid plans (Pro and Studio) unlock higher usage limits and premium features." },
      ...
      <div className="max-w-2xl mx-auto px-6 py-16 space-y-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Everything you need to know about creating films with AIFilmz.
          </p>
        </motion.div>
