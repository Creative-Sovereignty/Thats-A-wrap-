...
const SYSTEM_PROMPT = `You are a professional storyboard assistant for That's A Wrap, an AI filmmaking studio. You generate detailed scene descriptions for storyboard frames.
